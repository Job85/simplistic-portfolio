          ...
          <div className={`${styles.page_container} ${pageTransition && styles['page_transition']}`}>
            <div className={styles.container}>
              ...
              <h2 className={styles.h2}>
                Hi, I'&aposm <span className={styles.bold}>Julian Jernigan</span>, a <span className={styles.bold}>full-stack</span> software engineer with a focus on <span className={styles.bold}>back-end</span> development
              </h2>
            </div>
            {pageTransition && (
              <Button
